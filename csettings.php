...
if(isset($_POST['infosubmit'])){
  ...
  if($error == 0){
    $inad = $cx->update_company($apid, $bio, $cname, $locat, $address);
    if($inad == 1){
      $msg = '<script type="text/javascript">
              swal("Updated!", "Company Information updated successfully.", "success");
            </script>';
    }
    else{
      $msg = '<script type="text/javascript">
...
if(isset($_POST['changepassword'])){
  ...
  if($error == 0){
    $password = $cx->update_password($apid, $oldpassword, $newpassword);
    if($password == 1){
      $msg = '<script type="text/javascript">
...
$menu = $ux->menu_switch('c',0);

$studentpts = '';

$pinfo = $cx->get_company_edit_info($apid);
...
<head>
    ...
    <script type="text/javascript">
                      ...
                      $.ajax({
                          ...
                          success: function (data) {
                              ...
                              if(data=="done"){
                                  ...
                                  swal("Error!", "Error changing your logo. Try again", "error");
                                  $('#displayavat').fadeIn(20);
                                  $('#cropavat').fadeOut(1);
                                  $('#donebutcnt').fadeOut(1);
                              }
      ...
      function uploadedx(){
        swal({
            title: "Logo Changed!",
            text: "Your logo has been changed successfully.",
            type: "success",
      ...
      <div class="br-pagebody">
        ...
        <div class="row row-sm mg-t-20">
          ...
          <div class="col-lg-6 mg-t-20">
            ...
            <div class="card bd-0 shadow-base">
              <div class="pd-x-25 pd-t-25">
                 <h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1 mg-b-20">Change Logo</h6>
                <hr>
                <div class="mindsetx" style="min-height:20px;">
                    <div class="row" style="padding:20px 0;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="displayavat">
                            <div id="avatarbxz">
                                <img src="img/avatar/<?php echo $logo;?>" style="width:100%;border-radius: 150px;">
                            </div>
