...
if(isset($_POST['submit'])){
  ...
  if(empty($file) == false){
    ...
    if($fileupdt == 0){
        ...
        $msgerror .= "<br>Solution file size too big (Max image size 2MB)";
        $error++;
    }
  }
  else{
  ...
  if($error == 0){
    ...
    if($inad == 1){
      $msg = '<script type="text/javascript">
              swal("Task Created!", "Task has created successfully.", "success");
            </script>';
    }
    else{
      $msg = '<script type="text/javascript">
...
$tasks = $cx->get_total_tasks($apid);
$solutionx = $cx->get_total_task_solutions($apid);
$tasksolution = $cx->get_solution($apid);
$watch = $cx->get_watching_list($apid);
$watch_count = $cx->get_watch_count($apid);
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                <a href="company_profile"><img src="img/avatar/<?php echo $logo;?>" class="wd-80 rounded-circle" alt=""></a>
                <a href="company_profile"><h6 class="logged-fullname"><?php echo $fullname;?></h6></a>
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
           ...
           <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
            <div class="bg-purple rounded overflow-hidden">
              <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                <i class="ion ion-ios-eye tx-60 lh-0 tx-white op-7"></i>
                <div class="mg-l-20">
                  <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Watch List</p>
                  <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1"><?php echo $watch_count;?></p>
                </div>
              </div>
              <div id="ch4" class="ht-50 tr-y-1"></div>
            </div>
          ...
          <div class="col-lg-8">
            <div class="card bd-0 shadow-base">
              <div class="pd-x-25 pd-t-25">
                 <h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1 mg-b-20">New Task Solutions</h6>
                <hr>
                <?php echo $tasksolution;?>
