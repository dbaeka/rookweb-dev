...
if(isset($_POST['login'])){
  ...
  if($error == 0){
    $udata = $val->login($email, $password);
    ...
    <div class="row no-gutters flex-row-reverse ht-100v">
      <div class="col-md-6 bg-gray-200 d-flex align-items-center justify-content-center">
        <div class="login-wrapper wd-250 wd-xl-350 mg-y-30">
          ...
          <p class="tx-center mg-b-60">Hi there! sign in here.</p>
          <?php echo $msg;?>
          <form method="POST" action="">
            ...
            <div class="form-group">
              ...
              <a href="forgot_password" class="tx-info tx-12 d-block mg-t-10">Forgot password?</a>
            </div><!-- form-group -->
            <button type="submit" name="login" class="btn btn-info btn-block">Sign In</button>
          </form>
          <div class="mg-t-60 tx-center">Not yet a member? <a href="register" class="tx-info">Register</a></div>
        </div><!-- login-wrapper -->
      </div><!-- col -->
