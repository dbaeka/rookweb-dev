...
if($usertype == 's'){
  ...
  $profile = $ux->get_student_info($apid, $pagex);
  ...
  $fname = $userx['fname'];
  $fullname = $userx['fname'].' '.$userx['lname'];
  $profile = $ax->get_student_info($apid, $student, $pagex);
  $userz = $ux->user_email($apid);
  $email = $userz['email'];
  ...
  $profile = $cx->get_student_info($apid, $student, $pagex);
          ...
          <div class="col-lg-8 mg-t-20 mg-lg-t-0">
            <div class="card bd-0 shadow-base">
              <div class="pd-x-25 pd-t-25">
                 <h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1 mg-b-20">My Tasks</h6>
                <hr>
                <?php echo $profile['tasks'].$profile['range'].$profile['page'];?>
