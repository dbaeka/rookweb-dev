...
if($usertype == 's'){
  ...
  $trans = $ux->get_transactions($apid, $search, $pagex);
  $menu = $ux->menu_switch('s',6);
  ...
  $trans = $ax->get_transactions($apid, $search, $pagex);
  $menu = $ux->menu_switch('a',3);
  $fullname = $userx['fname'].' '.$userx['lname'];
  $fname = $userx['fname'];
  $email = $userz['email'];
  $logo = 'p.png';
  ...
  $trans = $cx->get_transactions($apid, $search, $pagex);
  $menu = $ux->menu_switch('c',3);
  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagetitle">
        ...
        <div>
          <h4>Transactions</h4>
          <p class="mg-b-0">Shows all your transactions</p>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="card bd-0 shadow-base">
              <div class="pd-x-25 pd-t-25">
                <h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1 mg-b-20">Transactions</h6>
                <form method="GET" action="">
                  <div class="input-group">
                    <input type="text" class="form-control" name="q" value="<?php echo $search;?>" placeholder="Search transactions by Wallet Number, Invoice Number, Transaction Number">
                ...
                <hr>
                <?php echo $trans['list'].$trans['page'].$trans['range'];?>
